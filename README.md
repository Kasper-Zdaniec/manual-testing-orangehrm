...
| TC-LOGIN-01  | Brak możliwości podejrzenia hasła              | 1. Otwórz ekran logowania na urządzeniu mobilnym (Mi Note 10 Lite, Google Chrome v138) 2. ...  | Hasło: admin123                                | Użytkownik może podejrzeć wpisywane hasło              | Nieudany  | Brak opcji podglądu hasła. Pole hasła zawsze zamaskowane. Testowane na Mi Note 10 Lite, Chrome |
| TC-UI-01     | Ocena czytelności rozmieszczenia przycisków    | 1. Zaloguj się jako Admin na Mi Note 10 Lite, Google Chrome v138 2. Przeglądaj różne moduły... | —                                              | Przejrzyste i logiczne rozmieszczenie przycisków akcji | Nieudany  | Przyciski są rozmieszczone w sposób nieintuicyjny. Dotyczy m.in. PIM i Organization Structure   |
...
| 2025-07-11  | Kasper Żdaniec| UI/UX         | TC-UI-01, 02 | Fail    | Przyciski akcji rozmieszczone nieintuicyjnie; brak zwijania menu |
