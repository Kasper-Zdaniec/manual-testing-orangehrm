...
| TC-PIM-05  | Walidacja uploadu zdjęcia – rozmiar pliku | 1. PIM → Add Employee  2. Wprowadź dane  3. Wybierz plik testowy.png o rozmiarze powyżej 1 MB  4. Zapisz       | testowy.png (plik >1 MB, przed kompresją)         | System powinien odrzucić plik i wyświetlić komunikat o przekroczeniu rozmiaru | Sukces    | Walidacja rozmiaru pliku działa prawidłowo, plik nie został przyjęty                             |
