...
|------------|-----------------------------------------------|-------------|-----------|-------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|----------------------------------------------------------------------------|-----------------------------------------------|-------------------|
| DEF-01     | Zmiany po edycji pracownika nie są widoczne bez przeładowania | PIM         | Średni    | 1. Zaloguj się jako Admin2. Przejdź do PIM3. Edytuj dane pracownika4. Zapisz zmiany5. Obserwuj dane na liście pracowników | Dane pracownika powinny być natychmiast widoczne po zapisaniu             | Zmiany widoczne dopiero po ręcznym przeładowaniu strony (F5 lub Refresh)   | Chrome 125, Firefox 127, Windows 10, demo 2025-07-11 | DEF-01.png        |
