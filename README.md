...
| 2025-07-11  | Kasper Żdaniec   | UI/UX        | TC-UI-01, TC-UI-02 | Fail | Przyciski akcji rozmieszczone nieintuicyjnie; brak zwijania przycisku/menu |
...
| IMP-07     | Brak zwijania się przycisku/menu              | UI/UX (Mobile) | Niski     | 1. Otwórz aplikację na Mi Note 10 Lite, Google Chrome v138  2. Kliknij przycisk/menu, który powinien się zwijać                    | Przycisk/menu zwija się poprawnie.                                          | Przycisk się nie zwija.                                                     | Mi Note 10 Lite, Google Chrome 138, Android 12, demo 2025-07-11             | IMP-07.mp4        |
...
Dodatkowo, w interfejsie użytkownika zauważono nieintuicyjne rozmieszczenie przycisków akcji oraz brak zwijania się przycisków/menu na urządzeniach mobilnych, co wpływa na ergonomię i nowoczesność UI.

**Załączniki:**  
- Zrzuty ekranu i nagrania dokumentujące defekty i usprawnienia (np. IMP-04.mp4, IMP-06.jpg, IMP-07.mp4)  
